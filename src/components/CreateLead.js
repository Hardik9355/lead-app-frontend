...
const CreateLead = ({ lead }) => {
  const { register, handleSubmit, setValue, reset } = useForm({
    defaultValues: lead || { name: '', mobile_number: '', email: '', product: '' },
  ...
  return (
    <Container>
        ...
        <Title>Add a new lead</Title> 
          ...
          <FormDetails>
            {/* <Label>Title</Label> */}
            <Input type="number" placeholder='Mobile Number' {...register('mobile_number', { required: true })} />
            {/* <Label>Publishing Year</Label> */}
            <Input type="text" placeholder='Name' {...register('name', { required: true })} />
            <Input type="email" placeholder='Email' {...register('email', { required: true })} />
            <Input type="text" placeholder='Product' {...register('product', { required: true })} />
